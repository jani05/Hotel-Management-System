            ...
            <td>
              <div class="action-group">
                <button type="button" class="action-btn edit-btn"
                  ...
                  data-studentid="<?php echo htmlspecialchars($row['StudentID']); ?>"
                  data-roomnumber="<?php echo htmlspecialchars($row['RoomNumber']); ?>"
                  data-roomtype="<?php echo htmlspecialchars($row['RoomType']); ?>"
                  data-bookingstatus="<?php echo htmlspecialchars($row['BookingStatus']); ?>"
                  data-roomstatus="<?php echo htmlspecialchars($row['RoomStatus']); ?>"
                  data-notes="<?php echo htmlspecialchars($row['Notes']); ?>"
                  data-checkin="<?php echo htmlspecialchars($row['CheckInDate']); ?>"
                  data-checkout="<?php echo htmlspecialchars($row['CheckOutDate']); ?>"
  ...
  <div id="editModal" class="modal">
    <div class="modal-content">
      ...
      <form id="editForm">
        ...
        <p><label>Booking ID:</label><br><input type="text" name="BookingID" id="editBookingID" required></p>
        <p><label>Student ID:</label><br><input type="text" name="StudentID" id="editStudentID" required></p>
        <p><label>Room Number:</label><br><input type="text" name="RoomNumber" id="editRoomNumber" required></p>
        ...
        <p><label>Room Status:</label><br><input type="text" name="RoomStatus" id="editRoomStatus" required></p>
        <p><label>Notes:</label><br><input type="text" name="Notes" id="editNotes" required></p>
        <p><label>Check In Date:</label><br><input type="date" name="CheckInDate" id="editCheckInDate" required></p>
        <p><label>Check Out Date:</label><br><input type="date" name="CheckOutDate" id="editCheckOutDate" required></p>
        <p><label>Booking Date:</label><br><input type="date" name="BookingDate" id="editBookingDate" required></p>
        <p><label>Price:</label><br><input type="number" name="Price" id="editPrice" required></p>
  ...
  <div id="createModal" class="modal">
    <div class="modal-content">
      ...
      <form id="createForm">
        ...
        <p><label>Booking ID: </label><br><input type="text" name="BookingID" required></p>
        <p><label>Student ID:</label><br><input type="text" name="StudentID" required></p>
        <p><label>Room Number:</label><br><input type="text" name="RoomNumber" required></p>
        <p><label>Room Type:</label><br>
        ...
        <p><label>Room Status:</label><br><input type="text" name="RoomStatus" required></p>
        <p><label>Notes:</label><br><input type="text" name="Notes" required></p>
        ...
        <p><label>Price:</label><br><input type="number" name="Price" required></p>
