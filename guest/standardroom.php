...
<head>
  ...
  <title>Standard Rooms - Villa Valore Hotel</title>
  ...
  <style>
    * {
    ...
    .hero {
      height: 60vh;
      background: linear-gradient(rgba(1, 128, 0, 0.4), rgba(1, 128, 0, 0.4)), url('images/haven_standard room.jpg');
...
<body>
  ...
  <section class="hero">
    <div class="hero-content">
      ...
      <p>Comfortable accommodations designed for relaxation and convenience</p>
    </div>
  </section>
  ...
  <section class="rooms-section">
    <div class="container">
      <div class="section-header">
        <h2>Our Standard Rooms</h2>
        <p>Choose from our selection of comfortable and well-appointed standard rooms</p>
      </div>
      <div class="rooms-grid">
        <!-- Room 1 -->
        <div class="room-card">
          <div class="room-image">
            <img src="images/haven_standard room.jpg" alt="Haven Standard Room">
            <div class="room-badge">Most Popular</div>
          </div>
          <div class="room-content">
            <h3 class="room-title">Haven Standard Room</h3>
            <p class="room-description">A peaceful retreat with modern amenities and comfortable furnishings. Perfect for solo travelers or couples seeking a relaxing stay.</p>
            ...
            <div class="room-price">₱200</div>
            <div class="price-details">Per Hour</div>
            <div class="room-actions">
              <a href="booking.php?room=haven_standard" class="btn-primary">Book Now</a>
        ...
        <div class="room-card">
          <div class="room-image">
            <img src="images/serenity_standard room.jpg" alt="Serenity Standard Room">
            <div class="room-badge">Garden View</div>
          </div>
          <div class="room-content">
            <h3 class="room-title">Serenity Standard Room</h3>
            <p class="room-description">Overlooking our beautiful garden, this room offers tranquility and natural beauty. Ideal for nature lovers and peace seekers.</p>
            <div class="room-features">
              <span class="feature-tag">1 Queen Bed</span>
              <span class="feature-tag">Up to 2 Guests</span>
              <span class="feature-tag">30 sq m</span>
              <span class="feature-tag">Garden View</span>
            </div>
            <div class="room-price">₱200</div>
            <div class="price-details">Per Hour</div>
            <div class="room-actions">
              <a href="booking.php?room=serenity_standard" class="btn-primary">Book Now</a>
              <a href="#" class="btn-secondary">View Details</a>
            </div>
          </div>
        </div>
        ...
        <div class="room-card">
          <div class="room-image">
            <img src="images/chamber_standard room.png" alt="Chamber Standard Room">
            <div class="room-badge">Business Ready</div>
          </div>
          <div class="room-content">
            <h3 class="room-title">Chamber Standard Room</h3>
            <p class="room-description">Designed with business travelers in mind, featuring a work desk and enhanced connectivity. Perfect for productive stays.</p>
            <div class="room-features">
              <span class="feature-tag">1 Queen Bed</span>
              <span class="feature-tag">Up to 2 Guests</span>
              <span class="feature-tag">32 sq m</span>
              <span class="feature-tag">Work Desk</span>
            </div>
            <div class="room-price">₱200</div>
            <div class="price-details">Per Hour</div>
            <div class="room-actions">
              <a href="booking.php?room=chamber_standard" class="btn-primary">Book Now</a>
              <a href="#" class="btn-secondary">View Details</a>
            </div>
          </div>
        </div>
  ...
  <section class="amenities-section">
    <div class="container">
      <div class="section-header">
        ...
        <p>Every standard room includes these essential amenities for your comfort</p>
      </div>
      <div class="amenities-grid">
        ...
        <div class="amenity-item">
          ...
          <div class="amenity-text">
            <h4>Coffee Maker</h4>
            <p>Complimentary coffee and tea</p>
          </div>
        </div>
        <div class="amenity-item">
          <div class="amenity-icon">
